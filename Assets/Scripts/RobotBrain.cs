...
public class RobotBrain : Agent
{
    ...
    {
        // ----- Рандомизация стартовых позиций (если включено и нет EnvironmentManager) -----
        // Когда назначен EnvironmentManager, он сам расставляет робота и мяч (с учётом
        // стен/пути/препятствий) ниже — простая рандомизация по прямоугольнику здесь
        // была бы бессмысленной и сразу же перезаписывается.
